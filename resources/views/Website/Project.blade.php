        ...
        <main class="lg:ml-80 w-full p-8 mt-4 lg:mt-0">
                ...
                <main class="flex-1 p-8 overflow-y-auto  bg-white">
                    <div class="flex flex-col gap-12">
                        ...
                        <div class="flex justify-center">
                            <div class="max-w-3xl text-center">
                                <h1 class="text-3xl md:text-4xl font-extrabold text-black ">Projects</h1><br>
                                <div class="border-l-2 border-blue-500 pl-4 space-y-6 text-left">
                                    <div>
                                        <h2 class="italic text-gray-600">
                                            "Not just an IT project – a meaningful contribution dedicated to making a
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 bg-gray-100 p-4">
                        ...
                        <div class="bg-white p-4 rounded-lg shadow-md flex flex-col">
                            <!-- Title -->
                            <!-- Image -->
                            <img src="{{ asset('images/plantation.jpg') }}" alt="Projects" class="w-full h-28 md:h-32 object-contain rounded-lg mb-2 bg-gray-100 
            transition-transform duration-300 ease-in-out transform hover:scale-105" loading="lazy">
                            ...
                            <p class="text-gray-600 font-bold text-xs leading-relaxed">
                                "Small hands, big impact – students greening the world."
                            </p>
                        </div>
