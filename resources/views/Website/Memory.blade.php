                ...
                <section class="bg-white py-12">
                    <div class="max-w-7xl mx-auto px-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                            <div class="relative">
                                <img src="{{ asset('images/collection1.jpg') }}" alt="Photo 1"
                                ...
                                <span
                                    ...
                                    Diwali Festival</span>
                            </div>

                            <div class="relative">
                                <img src="{{ asset('images/collection2.jpg') }}" alt="Photo 2"
                                    class="w-full h-48 object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300">
                                <span
                                    class="absolute bottom-2 left-2 bg-black bg-opacity-50 text-white text-sm px-2 py-1 rounded">Radhwani
                                    Concert</span>
                            </div>

                            <div class="relative">
                                <img src="{{ asset('images/collection3.jpg') }}" alt="Photo 3"
                                    class="w-full h-48 object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300">
                                <span
                                    class="absolute bottom-2 left-2 bg-black bg-opacity-50 text-white text-sm px-2 py-1 rounded">Travelling
                                    NuwaraEliya
                                </span>
                            </div>

                            <div class="relative">
                                <img src="{{ asset('images/collection4.jpg') }}" alt="Photo 3"
                                    class="w-full h-48 object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300">
                                <span
                                    class="absolute bottom-2 left-2 bg-black bg-opacity-50 text-white text-sm px-2 py-1 rounded">Cricwazz
                                    Cricket Tournament Kegalle</span>
                            </div>


                            <div class="relative">
                                <img src="{{ asset('images/collection5.jpg') }}" alt="Photo 3"
                                    class="w-full h-48 object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300">
                                <span
                                    class="absolute bottom-2 left-2 bg-black bg-opacity-50 text-white text-sm px-2 py-1 rounded">Travelling
                                    Kabaragala</span>
                            ...
                            <div class="relative">
                                <img src="{{ asset('images/collection6.jpg') }}" alt="Photo 3"
                                    class="w-full h-48 object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300">
                                <span
                                    class="absolute bottom-2 left-2 bg-black bg-opacity-50 text-white text-sm px-2 py-1 rounded">APL
                                    Champions</span>
                            </div>

                            <div class="relative">
                                <img src="{{ asset('images/collection7.jpg') }}" alt="Photo 3"
                                    class="w-full h-48 object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300">
                                <span
                                    class="absolute bottom-2 left-2 bg-black bg-opacity-50 text-white text-sm px-2 py-1 rounded">University
                                    Last Day</span>
                            </div>

                            <div class="relative">
                                <img src="{{ asset('images/collection8.jpg') }}" alt="Photo 3"
                                    class="w-full h-48 object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300">
                                <span
                                    class="absolute bottom-2 left-2 bg-black bg-opacity-50 text-white text-sm px-2 py-1 rounded">Radhawani
                                    Concert
                                </span>
                            </div>

                            <div class="relative">
                                <img src="{{ asset('images/collection9.jpg') }}" alt="Photo 3"
                                    class="w-full h-48 object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300">
                                <span
                                    class="absolute bottom-2 left-2 bg-black bg-opacity-50 text-white text-sm px-2 py-1 rounded">University
                                    Cricket team </span>
                            ...
                            <div class="relative">
                                <img src="{{ asset('images/collection10.jpg') }}" alt="Photo 3"
                                    class="w-full h-48 object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300">
                                <span
                                    class="absolute bottom-2 left-2 bg-black bg-opacity-50 text-white text-sm px-2 py-1 rounded">KCC
                                    Shoot Area</span>
                            </div>

                            <div class="relative">
                                <img src="{{ asset('images/collection11.jpg') }}" alt="Photo 3"
                                    class="w-full h-48 object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300">
                                <span
                                    class="absolute bottom-2 left-2 bg-black bg-opacity-50 text-white text-sm px-2 py-1 rounded">2022
                                    HNDIT Batch</span>
                            </div>

                            <div class="relative">
                                <img src="{{ asset('images/collection12.jpg') }}" alt="Photo 3"
                                    class="w-full h-48 object-cover rounded-lg shadow-md hover:scale-105 transition-transform duration-300">
                                <span
                                    class="absolute bottom-2 left-2 bg-black bg-opacity-50 text-white text-sm px-2 py-1 rounded">HNDIT
                                    Cultural Show Day</span>
                            </div>
